...
public class MainTest {
	...
	public void testMain() {
		...
		// TASK1 아래 args적절히 수정. MetricCollector.java를 완성하면, arff파일에 다양한 값들을 볼 수 있음.
		...
		String[] args = {"/Users/imseongbin/Desktop/PP1-DP","data/PP1-DP.arff"};
	...
	///Users/imseongbin/Desktop/fastjson
	
	@Test
	public void testForTasks2() {
		// TASK2 GitHub에서 작은 규모의 자바 프로젝트를 2개를 찾아, arff파일을 생성하시오. 파일이름은 [project이름].arff data디렉터리에 저장되게 하고
		// 생성이 된 후 commit/push해야 함.
		// 위 test main을 참고하여 실행하면 됨.
		
		String[] args = {"/Users/imseongbin/Desktop/fastjson","data/fastjson.arff"};
		assertEquals(args.length,2);
		Main.main(args);
		
		String[] args2 = {"/Users/imseongbin/Desktop/commons","data/commons.arff"};
